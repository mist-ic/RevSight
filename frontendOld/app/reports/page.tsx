    ...
    <div className="min-h-screen p-8" style={{ background: "hsl(var(--background))" }}>
      <div className="mb-8 animate-fade-in">
        ...
        <p style={{ color: "hsl(var(--muted-foreground))" }}>
          All past pipeline analysis runs and their generated reports.
        </p>
      </div>
      ...
      {loading ? (
        ...
        >
          ...
          <p className="text-sm" style={{ color: "hsl(var(--muted-foreground))" }}>
            Go to Home to generate your first pipeline analysis.
          </p>
          <Link
            href="/"
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-medium text-sm">
                        ...
                        {run.persona && (
                          <span
                            className="ml-2 text-xs capitalize px-2 py-0.5 rounded"
                            style={{
                      ...
                      <p
                        className="text-xs mt-0.5 flex items-center gap-1 mono"
                        style={{ color: "hsl(var(--muted-foreground))" }}
                      >
                        <Clock className="w-3 h-3" />
                        {new Date(run.created_at).toLocaleString()}
                        <span className="ml-2 opacity-60">{run.id.slice(0, 8)}</span>
                      </p>
                    </div>
                  </div>
